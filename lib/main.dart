...
Future<void> main() async {
  ...
  await Firebase.initializeApp(
    options: const FirebaseOptions(
      apiKey: 'AIzaSyDGhunpROXEvvDSzXNBHi8ax3cUtHAINOc',
      appId: "1:1004621188984:android:91d359050394a16282828d",
      messagingSenderId: "1004621188984",
      projectId: "chain-of-deeds-6ac7c",
    ),
  );
} else {
  await Firebase.initializeApp();
        ...
        builder: (context, orientation, screenType)
    {
      return  MultiBlocProvider(
        providers: [
          ...
          BlocProvider(create: (context) => CODBloc(),),
          BlocProvider(create: (context) => MemberBloc(),),
        ],
        child: MaterialApp(
          navigatorKey: NavigatorService.navigatorKey,
          debugShowCheckedModeBanner: false,
          title: 'Chain of Deeds app',
          theme: ThemeData(
